        ...
        <form>
          <div className="mb-4">
            ...
            <input
              ...
              value={createTaskFormData.titulo}
              type="text"
              id="titulo"
              name="titulo"
          ...
          <div className="mb-4">
            ...
            <textarea
              onChange={handleCreateTaskFormChange}
              value={createTaskFormData.descricao}
              id="descricao"
              name="descricao"
              className="h-36 mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            />
          </div>
          <div className="mb-4">
            ...
            <select
              onChange={handleCreateTaskFormChange}
              value={createTaskFormData.prioridade}
              id="prioridade"
              name="prioridade"
              className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            >
          ...
          <div className="mb-4">
            ...
            <input
              onChange={handleCreateTaskFormChange}
              value={createTaskFormData.dataConclusao}
              type="date"
              id="dataConclusao"
              name="dataConclusao"
              className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
